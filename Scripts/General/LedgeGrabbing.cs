...
public class LedgeGrabbing : MonoBehaviour
{
    ...
    public LayerMask whatIsLedge; // Layer mask to identify ledge targets
    ...
    private void LedgeDetection()
    {
        ...
        // Ensure the detected ledge is not the same as the last one
        if (ledgeHit.transform == lastLedge) return;

        // Ensure the ledge is within the maximum grab distance and the player is not already holding
